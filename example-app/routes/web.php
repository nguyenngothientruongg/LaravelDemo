...
|--------------------------------------------------------------------------
*/
Route::get('posts', [CustomAuthController::class, 'postsList'])->name('auth.postsList');
Route::get('favorities', [CustomAuthController::class, 'favoritiesList'])->name('auth.favoritiesList');
Route::get('hacker/xss', [CustomAuthController::class, 'xss'])->name('hackerlord');
